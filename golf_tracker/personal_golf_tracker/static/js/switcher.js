...
document.getElementById("changer").addEventListener("DOMSubtreeModified", function(e) {
    ...
    if (code == "page") {
        switch(state) {
            case '1':
            {
                $.getScript("https://s3.nl-ams.scw.cloud/golf-static/js/profile_settings.js");
            ...
            case '6':
            {
                $.getScript("https://s3.nl-ams.scw.cloud/golf-static/js/create_training.js");
            ...
            case '12':
            {
                $.getScript("https://s3.nl-ams.scw.cloud/golf-static/js/create_statistic.js");
